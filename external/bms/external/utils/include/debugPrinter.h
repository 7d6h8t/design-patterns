...
namespace utils {
    ...
    public:
        ...
        void Log(const std::string_view pFormat, Args&& ...args)
        {
            ...
            const std::string strMessage = std::vformat(formatter, std::make_format_args(strAppName, std::forward<Args>(args)...));
        ...
        void LogW(const std::wstring_view pFormat, Args&& ...args)
        {
            ...
            const std::wstring strMessage = std::vformat(formatter, std::make_wformat_args(wstrAppName, std::forward<Args>(args)...));
